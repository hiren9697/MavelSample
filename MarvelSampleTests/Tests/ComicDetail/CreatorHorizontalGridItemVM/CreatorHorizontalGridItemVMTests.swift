...
final class CreatorHorizontalGridItemVMTests: XCTestCase {
    var sut: TestableCreatorHorizontalGridItemVM!
    
    override func setUp() {
        super.setUp()
        sut = TestableCreatorHorizontalGridItemVM()
    }
}

// MARK: - Tests
extension CreatorHorizontalGridItemVMTests {
